...
class World:
    ...
    def spawn_at_player(self, player: "Player", entity_type: "EntityType" | str, offset: "Vector" | tuple[int,int,int] | Vector | None = None, **kwargs: Any) -> Awaitable["Entity"]: ...
    def spawn_projectile(self, shooter: "Entity", entity_type: "EntityType" | str, velocity: "Vector" | tuple[int,int,int] | Vector | None = None, **kwargs: Any) -> Awaitable["Entity"]: ...
