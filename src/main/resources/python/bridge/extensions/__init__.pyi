...
from bridge import ItemBuilder, BridgeCall, Item
import asyncio
...
class LootPool:
    ...
    def entry(self, item: Any, weight: int = 1, min_amount: int = 1, max_amount: int = 1, condition: Callable[..., bool] | None = None) -> Callable[[Callable[..., bool]], Callable[..., bool]]: ...
    def generate(self, context: Any = None, luck: float = 0.0) -> list[Item]: ...
    def generate_into(self, inventory: Any, context: Any = None, luck: float = 0.0) -> list[Item]: ...
...
class LootTable:
    ...
    def generate(self, context: Any = None, luck: float = 0.0) -> list[Item]: ...
    def generate_into(self, inventory: Any, context: Any = None, luck: float = 0.0) -> list[Item]: ...
    def generate_stacked(self, context: Any = None, luck: float = 0.0) -> list[Item]: ...
...
class ClientModSession:
    ...
    def command(self, capability: str, args: dict[str, Any] | None = None,
        handle: str | None = None, timeout_ms: int = 1000) -> BridgeCall: ...
    ...
    def set_permissions(self, capabilities: list[str], reason: str | None = None,
    ...
    def mic_level_subscribe(self, stream_id: str, interval_ms: int = 250,
        timeout_ms: int = 1000) -> BridgeCall: ...
    def mic_level_unsubscribe(self, stream_id: str, timeout_ms: int = 1000) -> BridgeCall: ...
    ...
    def audio_stream_set_volume(self, stream_id: str, volume: float = 1.0,
        timeout_ms: int = 1000) -> BridgeCall: ...
    def audio_stream_pause(self, stream_id: str, timeout_ms: int = 1000) -> BridgeCall: ...
    def audio_stream_resume(self, stream_id: str, timeout_ms: int = 1000) -> BridgeCall: ...
    def voice_subscribe(self, stream_id: str, source_player: str | None = None,
        mix: bool = False, timeout_ms: int = 1000) -> BridgeCall: ...
    def voice_unsubscribe(self, stream_id: str, timeout_ms: int = 1000) -> BridgeCall: ...
    ...
    def client_pref_set(self, key: str, value: Any, timeout_ms: int = 1000) -> BridgeCall: ...
    def client_pref_get(self, key: str, timeout_ms: int = 1000) -> BridgeCall: ...
