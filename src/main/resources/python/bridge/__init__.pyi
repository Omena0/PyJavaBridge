...
class World(ProxyBase):
    ...
    def spawn_particle(self, particle: Particle, location: Location, count: int = 1, offset_x: float = 0, offset_y: float = 0, offset_z: float = 0, extra: float = 0, data: Any = None, force: bool = False) -> Awaitable[None]: ...
...
class Datapack:
    ...
    def register_model(self, namespace: str, path: str, model_json: dict[str, Any]) -> None: ...
    def register_advancement(self, namespace: str, path: str, advancement_json: dict[str, Any]) -> None: ...
    def register_predicate(self, namespace: str, path: str, predicate_json: dict[str, Any]) -> None: ...
    def register_worldgen(self, namespace: str, category: str, path: str, json_obj: dict[str, Any]) -> None: ...
    def register_tag(self, namespace: str, tag_type: str, tag_id: str, values: list[str], replace: bool = False) -> None: ...
    def register_registry_entry(self, namespace: str, registry: str, path: str, entry_json: dict[str, Any]) -> None: ...
    def register_damage_type(self, namespace: str, id: str, json_obj: dict[str, Any]) -> None: ...
    def register_chat_type(self, namespace: str, id: str, json_obj: dict[str, Any]) -> None: ...
