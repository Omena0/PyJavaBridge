...
def event(func: Callable[[Event], Any] | None = None, *, once_per_tick: bool = False, priority: str | EventPriority = "NORMAL", throttle_ms: int = 0, non_blocking: bool = False) -> Callable[..., Any]: ...
