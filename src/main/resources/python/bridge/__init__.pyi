...
class Player(Entity):
    ...
    _default_bank: Any
    _default_mana_store: Any
    _default_level_system: Any
    balance: float
...
class BossBarDisplay:
    ...
    progress: float
    visible: bool
    def link_to(self, cooldown: "Cooldown", player: "Player") -> None: ...
    def linked_to(self, source: Any, player: "Player") -> None: ...
...
class ImageDisplay:
    def __init__(self, location: "Location", image: str | Any, pixel_size: float = ..., dual_sided: bool = False, dual_side_mode: str = "mirror") -> None: ...
    def teleport(self, location: "Location") -> None: ...
    def remove(self) -> None: ...
